...
Changing prototype is quite expensive for an engine and it breaks inner optimization for object property access operations. Changing it on the fly, no matter in which way, is not recommended.
